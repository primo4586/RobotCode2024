...
public class ShootBase extends ParallelDeadlineGroup {
  
  public ShootBase() {
    super(Commands.waitSeconds(0.5).andThen(new FeedToShooter()));
    addCommands(
      new ShooterArmMoveToAngle(shooterArmConstants.SHOOT_BASE_ANGLE),
      new ShooterSetSpeedForever(shooterConstants.SHOOT_BASE_SPEED)
    );
  }
}
