...
public class CollectUntilNote extends Command {
  ...
  public void initialize() {
    double robotVelocity = Math.abs(CommandSwerveDrivetrain.getInstance().getState().speeds.vxMetersPerSecond)
        + Math.abs(CommandSwerveDrivetrain.getInstance().getState().speeds.vyMetersPerSecond);
